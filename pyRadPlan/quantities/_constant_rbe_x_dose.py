...
class ConstantRbeXDose(FluenceDependentQuantity):
    """Constant RBE x dose quantity backed directly by the dij.constant_rbe_x_dose matrix."""

    unit = ureg.gray
    dim = 1
    identifier = "constant_rbe_x_dose"
    name = "constant_rbe_x_dose"
